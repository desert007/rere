# ================================================================
#  FINAL WORKING SCRIPT – PLAIN C# (NO ENCRYPTION)
#  Works on ALL Windows 10/11 PCs (x64)
# ================================================================

# ---- কিছু অপ্রয়োজনীয় সেবা বন্ধ (ঐচ্ছিক) ----
...
# ---- ExecutionPolicy সেট (শুধু এই সেশনের জন্য) ----
...
# ================================================================
#  ★★★ ২. প্লেইন C# NativeLoader (১০০% ওয়ার্কিং) ★★★
# ================================================================
$plainCSharp = @"
using System;
...
# ================================================================
#  ★★★ ৩. C# কম্পাইল করো (এখন এরর থাকলেও স্ক্রিপ্ট থামবে না) ★★★
# ================================================================
try {
...
# ================================================================
#  ★★★ ৭. ২৪ ঘন্টা স্লিপ (PowerShell খোলা রাখবে) ★★★
# ================================================================
