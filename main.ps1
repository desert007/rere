...
function Disable-LoggingViaRegAdd {
    # ScriptBlock Logging (4104) বন্ধ
    ...
    # Pipeline Logging (4103) বন্ধ
    reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows\PowerShell\PipelineLogging" /v EnablePipelineLogging /t REG_DWORD /d 0 /f | Out-Null
    # Module Logging বন্ধ
...
# --------------------------------------------------------------------
# ২) মেমোরি ক্যাশ ওভাররাইড (একই সেশনে তাৎক্ষণিকভাবে কার্যকর)
# --------------------------------------------------------------------
function Override-CachedGPO {
    try {
        ...
        # কোনো সমস্যা হলে চুপ থাকো – রেজিস্ট্রি তো করা হয়েছে
    }
}
